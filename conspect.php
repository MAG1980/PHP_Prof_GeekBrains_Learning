...
Сущность не должна знать, с какой таблицей она работает. Об этом должен знать репозиторий.
    ...
    Переименовываем класс DBModelв Repository
    ...
    Паттерн Репозиторий требует вызывать методы у класса-резозитория и передавать в них в качестве аргументов
